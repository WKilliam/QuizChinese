...
public class QuestionHelper {
    ...
    public static ArrayList<Question> getEasyQuestions() {
        ...
        easyList.add(new Question("?", "车","FACILE", R.drawable.car, 0));
        easyList.add(new Question("Cette image signifie quel caractère?", "火","FACILE", R.drawable.fire, 0));
        easyList.add(new Question("Cette image signifie quel caractère?", "森","FACILE", R.drawable.forest, 0));
        easyList.add(new Question("Cette image signifie quel caractère?", "月","FACILE", R.drawable.moon, 0));
        easyList.add(new Question("Cette image signifie quel caractère?", "山","FACILE", R.drawable.mountain, 0));
        easyList.add(new Question("Cette image signifie quel caractère?", "日","FACILE", R.drawable.sun, 0));
        easyList.add(new Question("Cette image signifie quel caractère?", "水","FACILE", R.drawable.water, 0));
        return easyList;
    }
